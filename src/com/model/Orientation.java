...
public class Orientation {
	 ...
	 * 
	 * @param nom
	 *            - le nom donnée à l'orientaiton
	 * @param escaliers
	 *            - Liste des escaliers qui compose l'orientation Construit
	 *            l'objet Orientation du nom du premier parametre et cree
	 *            HashMap avec des couples id/Escalier
	 */
	...
	/**
	 * Setter nom de l'orientation
	 * 
	 * @param nom
	 *            - nouveau nom de l'orientation
	 */
	...
	/**
	 * Getter liste des escaliers de l'orientation
	 * 
	...
	/**
	 * Setter liste des escaliers de l'orientation
	 * 
	 * @param escalier
	 *            - liste des id/Escalier à affecter setNom permet de remplacer
	 *            la liste des couples id/Escalier pour une autre liste de
	 *            couple
	 */
	...
	/**
	 * Methode pour cloner les orientations
	 */
	public Object clone() {
